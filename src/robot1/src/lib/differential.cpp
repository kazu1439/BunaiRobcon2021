...
Differential::Differential(float t_const_sec, float ctrl_period_sec) : t_const_sec_(t_const_sec), ctrl_period_sec_(ctrl_period_sec)
{
    ...
    {
        t_const_sec_ = ctrl_period_sec_ * 2;
    }
...
void Differential::set(float t_const_sec, float ctrl_period_sec)
{
    ...
    {
        t_const_sec_ = ctrl_period_sec * 2;
    }
    else
    {
    ...
    // std::cout<< "	t_const_sec_=" << 	t_const_sec_<<std::endl;
    // std::cout<< "	ctrl_period_sec_=" << ctrl_period_sec_<<std::endl;
...
float Differential::filter(float input)
{
    ...
    input_prev_ = input;
    // std::cout<< "input - input_prev_=" << input - input_prev_ <<std::endl;
    // std::cout<< "coeff_a_=" << coeff_a_<<std::endl;
